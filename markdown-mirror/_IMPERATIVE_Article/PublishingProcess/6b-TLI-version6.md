# Markdown Copy: `_IMPERATIVE_Article/PublishingProcess/6b-TLI-version6.TEX`

Preservation note: this is a browsing copy generated from the original source.

- Source type: `tex`
- Source path: `_IMPERATIVE_Article/PublishingProcess/6b-TLI-version6.TEX`
- SHA256: `e446695f7f18cabab62d8ce77e256f0c464f50460350481c9e6e54277ed05799`
- Generated: `2026-02-22 13:03:22 UTC`
- Original file: `[6b-TLI-version6.TEX](../../../_IMPERATIVE_Article/PublishingProcess/6b-TLI-version6.TEX)`
...
\tolerance=200
\overfullrule=3pt
\font\rmp=cmr10 scaled 1000
\font\itp=cmti10 scaled 1000
\font\bfp=cmbx10 scaled 1000
\font\rm=cmr10 scaled 1200
\font\it=cmti10 scaled 1200
\font\bf=cmbx10 scaled 1200
\font\bfit=cmmib10 scaled 1200
\font\rml=cmr10 scaled 1300
\font\itl=cmti10 scaled 1300
\font\bfl=cmbx10 scaled 1300
\def\cl{\centerline}
\def\ni{\noindent}
\def\hsrg{\leftskip 0.0cm \rightskip 0.0cm}
...
\def\stb{\vskip 11pt \ni}
\def\sbt{\vskip 3.5pt \ni}
\def\...{.\hskip2pt.\hskip2pt.}
\footline={\line{\hss\rm\number\pageno\hss}}
%\nopagenumbers
...
\ni {\bfp Abstract:}~~The prevailing trend of deeming subjective
...
\sta
\cl{\bf The Tangled Rehabilitation of Consciousness}
\sat
...
character or {\it qualia\/} of conscious experiences. The attempts to
...
most general quale {\it experientialness\/} or {\it
...
\stb
{\itl The idea of epiphenomenal consciousness}
\sbt
...
inert. There is also nothing counterlogical in advancing a {\it theory\/}
...
consciousness can serve as an {\it empirical basis\/} for our
...
difference to {\itp me}.
\ecit
\ni But, on pain of self-contradiction, he cannot assure us that
...
of the causal closure of the physical universe as we know it. {\it
...
there are {\it very\/} serious reasons to do so. Are there, then, any
...
have any factual evidence in support of it. Amazingly, there {\it is\/}
...
philosophers: the conceptual aspect --- what Free Will {\it means\/}
and whether it is compatible with determinism --- and the epistemic
aspect --- how we can get to {\it know\/} the truth about the
...
{\it behave}. I will give an answer to this practical question by
...
{\it incompatibilist\/} variety of freedom, I am nevertheless
...
but {\it a call for attacking the nomist assumption\/} --- the
...
thesis {\it A\/} only if we have first established, or have at
least some ground to suppose, that {\it A\/} is true. It seems
...
rather than {\it natural\/} scientific, but as far as it is
...
wrong, {\it but we are wrong unavoidably}, because we cannot
...
behaviour could not, out of {\it nomic necessity}, have taken
...
\sta
\cl{\bf The Specific Features of the Libertarian Imperative}
\sat
...
or investigating {\it these same efforts\/} as the exemplars of
non-nomic events. The logical basis of the Imperative does {\it
...
\sta
\cl{\bf The Libertarian Imperative,}

\cl{\bf William James's Will to Believe, and Pascal's Wager}
\sat
...
the problem I address is {\it intellectually\/} decidable,
...
be applied {\it extremely\/} restrictedly: for justifying only
{\it very\/} specific beliefs (roughly speaking). For
...
\cl{\bf Approaches to the Free Will Problem}
\sat
...
impossible to find out that our activity is {\it not\/}
...
understood as follows: {\it Given that one is the way one
actually is}, if one behaves or will try to behave as a
libertarian, one's such activity is epistemically the most
advantageous of all {\it actually\/} possible --- that is: both
{\it logically\/} and {\it nomically\/} possible --- ways of
...
future does not exist {\it yet}. They argue that time is like space,
...
that the causal process is continuous: the state S1 {\it changes\/}
...
attempt) because it is based on our ability, if we have it, to {\it
...
Chalmers,~D.~(1996), {\itp The Conscious Mind\/} (New York: Oxford
University Press).

Churchland,~P.~(1995), {\itp The Engine of Reason, The Seat of the
...
Hodgson,~D.~(1991), {\itp The Mind Matters\/} (Oxford: Oxford
University Press).

Hodgson,~D.~(1994), `Why Searle has not rediscovered the mind',
{\itp Journal of Consciousness Studies}, {\bfp 1\/} (2), pp.~264--74.

Hodgson,~D.~(1996), `The easy problems ain't so easy', {\itp
Journal of Consciousness Studies}, {\bfp 3\/} (1), pp.~69--75.

Jackson,~F.~(1982), `Epiphenomenal qualia', {\itp Philosophical
Quarterly}, {\bfp 32}, pp.~127--36.

James,~W.~(1979), `The Will to Believe', in {\itp The Works of
William James --- The Will to Believe}, ed.~F.~Burkhardt
(Cambridge, MA: Harvard University Press).

Lewis,~D.~(1995), `What experience teaches', in {\itp Mind and
...
Searle,~J.~(1992), {\itp The Rediscovery of the Mind\/} (Cambridge,
MA: The MIT Press).
...
mind--body problem', {\itp Journal of Consciousness Studies}, {\bfp
3\/} (3), pp.~217--30.
