...
- Original article corpus: [`_IMPERATIVE_Article/README.md`](_IMPERATIVE_Article/README.md)
- Publishing workflow records: [`_IMPERATIVE_Article/PublishingProcess/README.md`](_IMPERATIVE_Article/PublishingProcess/README.md)
- Responses dossier: [`_IMPERATIVE_Responses/README.md`](_IMPERATIVE_Responses/README.md)
- Markdown browsing copies of all originals: [`markdown-mirror/README.md`](markdown-mirror/README.md)

## Archival Principles Used

- **Originals preserved as-is** in `_IMPERATIVE_Article/*` and `_IMPERATIVE_Responses/*`.
...
- First-time reader (fast orientation):
  ...
  2. [`_IMPERATIVE_Article/_TheLibertarianImperative.pdf`](_IMPERATIVE_Article/_TheLibertarianImperative.pdf)
...
- Historical/process reader (deep path):
  ...
  3. Reception dossier: [`_IMPERATIVE_Responses/Responses-to-Imperative.pdf`](_IMPERATIVE_Responses/Responses-to-Imperative.pdf)
